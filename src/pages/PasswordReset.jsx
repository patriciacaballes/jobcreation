  ...
  return (
    <>
      <div className="reset-password relative flex flex-1 flex-col overflow-hidden px-4 py-8 sm:px-6 lg:px-8 ">
        <div className="flex flex-1 flex-col items-center justify-center pt-12 pb-20" id="reset-form">
          <h2  className="text-2xl font-bold ">Reset Password</h2>
          <h3 className="send-pass text-s pb-2 text-center ">We will send you a password reset link connected to your existing account</h3>
          <form className="w-full max-w-sm" onSubmit={handleSubmit} >
          <div className="form-login flex flex-col mb-6">
              <label className="block text-sm font-semibold leading-6 text-gray-900" id="email">Email</label>
